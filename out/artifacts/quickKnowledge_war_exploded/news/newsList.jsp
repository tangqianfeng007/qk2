    ...
    <div class="row">
        ...
        <script type="text/javascript">
            function aa() {
                ...
                if (url.search(/getNewsList.action/) == -1) {
                    selectLeft(1, 1);//上方 新闻
                }
                else {
            ...
            <table style="font-size: 15px">
                ...
                <s:iterator value="#request.list" status="statu" id="item">
                    <tr>
                        ...
                        <td>
                            <span class="content_attach"><s:property value="newsPosted"/></span>
                        </td>

                        <s:if test="#session.msg!=null && #item.userId  ==  #session.msg.id || #session.msg.role_id==1">
                            <td>
                                 <span>
                                     <a href="/news/newsChange.action?id=<s:property value="newsId" />"
                                        class="button">编辑</a>
                                     <a href="javascript:return false;" class="button"
                                        onclick="deleteInfo(<s:property value="newsId" />,this)"/>
                                     删除
                                     </a>
                                 </span>
                            </td>
