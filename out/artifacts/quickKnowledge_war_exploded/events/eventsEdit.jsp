    ...
    <div class="row">
        ...
        <div class="seven" id="centerArea">
            ...
            <div class="ep_summary" style="margin-top: 10px;">
                <form action="/edit/eventsEdit.action" name="form" onsubmit="return checkSub();" id="form"
                      method="post">
                    <table style="width: 548px;margin-top: 0px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="eventKeywords" placeholder="请输入活动关键字" class="g-ipt"
                                       value=""
                                       style="width:80%;border:0;height: 20px;"/>
                            </td>
                        </tr>
