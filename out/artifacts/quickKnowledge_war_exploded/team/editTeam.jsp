                ...
                <form action="/team/doEditTeam.action" name="form" id="form" method="post" onsubmit="return formSub()">
                    <table style="width: 548px;margin-top: 0px;">
                        <tr>
                            ...
                            <td>
                                <input name="virtualTeamBean.vtId" value="${virtualTeamBean.vtId}" id="vtId"
                                       type="hidden"/>
                                <input name="virtualTeamBean.rfpInfoId" value="${virtualTeamBean.rfpInfoId}"
                                       id="rfpInfoId" type="hidden"/>
                                <input name="virtualTeamBean.vtName" value="${virtualTeamBean.vtName}" id="vtName"
                                       class="g-ipt"
