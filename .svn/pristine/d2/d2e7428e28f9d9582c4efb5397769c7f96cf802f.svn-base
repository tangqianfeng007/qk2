...
public class RFPAction extends ActionSupport {
    ...
    private String pageTools2 = null;
    ...
    public String RFPCommentPage() {
        ...
        Page page = new Page(pageNumber, count, 6, list);
        PageTool pt = new PageTool();
        pageTools = pt.getPageStringForjs("/ajax/RFPCommentPage.action", page);
        setPageTools2(pageTools);
        this.commentList = page.getResult();
        dealComment();
        return SUCCESS;
    }
    ...
    public String getPageTools2() {
        return pageTools2;
    }

    public void setPageTools2(String pageTools2) {
        this.pageTools2 = pageTools2;
    }
}
