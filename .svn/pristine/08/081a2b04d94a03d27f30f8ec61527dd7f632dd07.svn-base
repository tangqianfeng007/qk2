                ...
                <s:iterator value="#request.list" status="statu" id="item">
                    <tr>
                        <td class="titleListtd">
                            <a href="/enterpriseBids/enterpriseBidsAll!enterpriseBidsContent.action?cfbId=<s:property value="cfbId"/>"><s:property
                                    value="cfbTitle"/></a>
                        </td>
                        <td>
                        ...
                        <td>
                            <span>
                                <a href="/enterpriseBids/enterpriseBidsAll!enterpriseBidsContent.action?cfbId=<s:property value="cfbId"/>"
                                   class="button">评论</a>
                                <a href="/enterpriseBids/getEnterpriseEditBids.action?cfbId=<s:property value="cfbId"/>"
                                   class="button">编辑</a>
                                <a href="/enterpriseBids/enterpriseDeleteBids.action?cfbId=<s:property value="cfbId"/>"
                                   class="button">删除</a>
                            </span>
                        </td>
                    </tr>
