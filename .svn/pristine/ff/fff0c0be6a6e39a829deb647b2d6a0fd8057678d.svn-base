...
public class RfpInfoCommentDaoImp implements RfpInfoCommentDao {
    ...
    public List<RfpInfoCommentBean> getRfpInfoCommentList(Integer pageNumber, Integer pageSize, Integer rfpInfoId) {
        ...
        try {
            connection = dataSource.getConnection();
            preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setInt(1, rfpInfoId);
            resultSet = preparedStatement.executeQuery();
    ...
    public Boolean insert(RfpInfoCommentBean rfpInfoCommentBean) {
        ...
        try {
            connection = dataSource.getConnection();
            preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setInt(1, rfpInfoCommentBean.getUserId());
            preparedStatement.setInt(2, rfpInfoCommentBean.getRfpInfoId());
            preparedStatement.setString(3, rfpInfoCommentBean.getRicContent());
            preparedStatement.setString(4, rfpInfoCommentBean.getRicPosted());
            preparedStatement.setString(5, rfpInfoCommentBean.getRicRemark());
