...
public class SiteCommentDaoImp implements SiteCommentDao {
    ...
    public Integer insertSiteCommentBean(SiteCommentBean siteCommentBean) {
        ...
        try {
            ...
            connection = dataSource.getConnection();
            preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setInt(1, siteCommentBean.getUserId());
            preparedStatement.setString(2, siteCommentBean.getScTitle());
            preparedStatement.setString(3, siteCommentBean.getScContent());
            preparedStatement.setInt(4, siteCommentBean.getScCount());
            preparedStatement.setString(5, siteCommentBean.getScPosted());
            preparedStatement.setString(6, siteCommentBean.getScRemark());
