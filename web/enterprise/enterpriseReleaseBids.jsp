...
<c:if test="${responseMsg!=null}">
    <script type="text/javascript">
        ...
        if (${responseMsg=="1"}) {
            alert("添加成功");
            location = "/bids/bidsAll!bidsList.action";
        } else {
            alert("添加失败");
        }
    </script>
    ...
    <div class="row">
        ...
        <div class="seven" id="centerArea">
            ...
            <div class="ep_summary" style="margin-top: 10px;">
                <form action="/enterpriseBids/enterpriseBidsRelease.action" onsubmit="return checkSub()" name="form"
                      id="form" method="post">
                        ...
                        <tr>
                            <td colspan="2" class="text_indent">
                                <textarea id="cfbDetails" name="cfbDetails"
                                          style="width:100%;height:250px;visibility:hidden;resize: none;">${callforbitBean.cfbDetails}</textarea>
                            </td>
                        </tr>
                    </table>
