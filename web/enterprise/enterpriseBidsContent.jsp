        ...
        <div class="seven" id="centerArea">
            ...
            <div class="ep_summary" style="border: 0">
                <div id="lists">
                    ...
                    <%--<input id="cfbStatus" name="cfbStatus" type="hidden" value="${callforbitBean.cfbStatus}"/>--%>
...
<script type="text/javascript">
    ...
    function submitComment() {
        ...
        var htmlobj = $.ajax({
            url:"/enterpriseBids/enterpriseResponseBidsUser.action",
            type:'POST',
    ...
    function getPage(page) {
        ...
        var htmlobj = $.ajax({
            url:"/enterpriseBids/enterpriseBidsReview.action",
            data:jsonData,
            cache:false,
            async:false
        });
    ...
    function winBids(cfbId, userId) {
        var jsonData = {cfbId:cfbId, userId:userId};
        var htmlobj = $.ajax({
            url:"/enterpriseBids/expertWinBids.action",
            data:jsonData,
            cache:false,
            async:false
        });
