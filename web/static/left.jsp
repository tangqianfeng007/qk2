...
<ul class="sidebar">
    ...
    <li class="selected">
                                       <span class="leftBar">
                                            <ul class="sidebar">
                                                <li class="sidebar_li"><a href="/man/getManList.action?pageNumber=1">注册管理</a>
                                                </li>
                                            </ul>
                                       </span>
                                        ...
                                        <span class="leftBar">
                                            <ul class="sidebar">
                                                <li class="sidebar_li"><a href="/news/getNewsList.action?pageNumber=1">新闻管理</a>
                                                </li>
                                            </ul>
                                       </span>
             <span class="leftBar">
                                            <ul class="sidebar">
                                                <li class="sidebar_li"><a href="/events/getEventsList.action?pageNumber=1">活动管理</a>
                                                </li>
                                            </ul>
                                       </span>
             <span class="leftBar">
                                            <ul class="sidebar">
                                                <li class="sidebar_li"><a href="/pubs/getPubsList.action?pageNumber=1">出版物管理</a>
                                                </li>
                                            </ul>
                                       </span>
             <span class="leftBar">
                                            <ul class="sidebar">
                                                <li class="sidebar_li"><a href="/comments/getCommentsList.action?pageNumber=1">站点评论管理</a>
                                                </li>
                                            </ul>
                                       </span>
    </li>
    ...
    <li class="selected">
                                     <span class="leftBar">
                                        <ul class="sidebar">
                                            ...
                                            <li class="sidebar_li"><a href="/team/myJoinTeamList.action">我加入的团队</a></li>
                                            <li class="sidebar_li"><a href="/rfp/getMyRfpInfoList.action">我的RFP</a></li>
                                            <li class="sidebar_li"><a href="/userInfo/userEdit.jsp">我的资料</a></li>
                                            <li class="sidebar_li"><a href="/bids/bidsNoticeList.action?noticeType=1">我的中标结果</a>
                                            </li>
                                        </ul>
                                      </span>
    </li>
    ...
    <li class="selected">
                          <span class="leftBar">
                            <ul class="sidebar">
                                <li class="sidebar_li"><a href="/bids/bidsAll!bidsList.action">投标列表</a></li>
                                <li class="sidebar_li"><a href="/bids/bidsNoticeList.action?noticeType=0">投标公告</a></li>
